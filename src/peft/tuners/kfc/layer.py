...
class KFCLoraLayer(BaseTunerLayer):
    ...
    def set_alpha(
        ...
        """
        Sets the alpha value for the KFC trained layer.
...
class Linear(nn.Module, KFCLoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        KFCLoraLayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, KFCLoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        KFCLoraLayer.__init__(self, base_layer)
...
class Conv2d(nn.Module, KFCLoraLayer):
