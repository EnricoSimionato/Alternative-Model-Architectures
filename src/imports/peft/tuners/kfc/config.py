...
@dataclass
class KFCLoraConfig(PeftConfig):
    """
    ...
    loftq_config: Union[KFCLoftQConfig, dict] = field(
        default_factory=dict,
        metadata={
            "help": (
    ...
    runtime_config: KFCLoraRuntimeConfig = field(
        default_factory=KFCLoraRuntimeConfig, metadata={"help": "Runtime configurations"}
    )
    ...
    def __post_init__(self):
        self.peft_type = PeftType.KFCLORA
        self.target_modules = (
